...
if TYPE_CHECKING:
    from jaxonomy.framework import SystemBase, ContextBase
...
def _forward(
    ...
    t0 = context.time
    results = jaxonomy.simulate(system, context, (t0, t0 + dt))
...
# Dummy subclass of brax.envs.base.State to distinguish from jaxonomy.State
# This uses flax.struct.dataclass for consistency with brax, although this is
# different from how we define custom pytrees in the rest of jaxonomy.
