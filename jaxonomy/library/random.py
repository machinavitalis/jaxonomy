...
# NOTE: Pure-numpy versions of RandomNumber and WhiteNoise are not yet implemented.
# These would be needed when running with a numpy-only backend (no JAX).  The current
# blocks delegate to jax.random, which requires JAX to be available.
