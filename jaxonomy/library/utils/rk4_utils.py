...
# NOTE: These RK4 utilities are intentionally standalone to minimize dependencies.
# If simulator-level ODE utilities grow further, these could be consolidated there.
