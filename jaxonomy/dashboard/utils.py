...
def get_ignored_files(directory: str) -> set:
    """Get a set of files that are ignored by the gitignore or jaxonomyignore file
    ...
    jaxonomyignore_file = os.path.join(directory, ".jaxonomyignore")

    ignore_patterns = []
    if os.path.exists(jaxonomyignore_file):
        with open(jaxonomyignore_file, "r") as f:
            ignore_patterns = [
