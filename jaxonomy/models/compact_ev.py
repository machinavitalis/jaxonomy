...
class CompactEV(LeafSystem):
    ...
    def axel(
        ...
        i dont know how this will affect jaxonomy.
        """
        Crr = 0.01
        intertia_kgm2 = 0.1
    ...
    def ode(self, time, state, *inputs, **parameters):
        ...
        mot_volt_based_enable_state = state.discrete_state.mot_volt_based_enable
        app_zoh_state = state.discrete_state.app_zoh
        bpp_zoh_state = state.discrete_state.bpp_zoh
        veh_spd_zoh_state = state.discrete_state.veh_spd_zoh
