...
Series RC network built from acausal electrical components and compiled
through index reduction.
...
Files
-----
RCNetwork.fmu          the FMU
RCNetwork_ref.csv      reference solution computed by Jaxonomy
RCNetwork_ref.opt      options used to compute it
rcnetwork_slave.py  the model source, for reference
