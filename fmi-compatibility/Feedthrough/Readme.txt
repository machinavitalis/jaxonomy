...
Scalar and vector feedthrough. Exercises array-valued FMI variables
alongside plain scalars.
...
Files
-----
Feedthrough.fmu          the FMU
Feedthrough_ref.csv      reference solution computed by Jaxonomy
Feedthrough_ref.opt      options used to compute it
Feedthrough_in.csv       input signals
feedthrough_slave.py  the model source, for reference
