...
Model tests should only be intended to test json ingestion, and any pre-processing that happens _before_ the system and context are made ready for simulation by jaxonomy. Executing simulations should be avoided whenever possible, and testing requiring running simulation should be implemented in jaxonomy directly, i.e. no json.
